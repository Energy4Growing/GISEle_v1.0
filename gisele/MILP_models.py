...
def MILP_without_MG(case_study,n_clusters,coe,voltage,resistance,reactance,Pmax,line_cost,distance_constraint,voltage_constraint,Abase,Vmin):
    ############ Create abstract model ###########
    print('MILP WITHOUT MG- aaa')
    model = AbstractModel()
    data = DataPortal() 
    ...
    data.load(filename=os.path.join(MILP_input_folder, 'PS_distance.csv'), param=model.PS_distance)
